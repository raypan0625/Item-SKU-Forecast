...
# assortment_out <- read_excel(paste0("C:/Users/Yulin Pan/Desktop/woh calculation files/Outdoor Assortment ", month(Assort_Date),".", day(Assort_Date), ".", Year, ".xlsx"), sheet = "Forecast by StockKey - PCS", 
#      skip = 3)
...
```{r}
#Seasonality
season_out<-read_excel("C:/Users/Yulin Pan/Desktop/48&12&4/Oct 2023/seasonality.xlsx", sheet = "Outdoor sea")
...
# Dec_out_amz = 0.0353
# 
# Jan_out_firepit = 0.0367
# Feb_out_firepit = 0.0405
# Mar_out_firepit = 0.0904
# Apr_out_firepit = 0.1360
# May_out_firepit = 0.1470
# Jun_out_firepit = 0.1093
# Jul_out_firepit = 0.0885
# Aug_out_firepit = 0.0731
# Sep_out_firepit = 0.0828
# Oct_out_firepit = 0.0647
# Nov_out_firepit = 0.0748
# Dec_out_firepit = 0.0562
# 
# 
# season_out<-data.frame(c(Jan_out,Feb_out,Mar_out,Apr_out,May_out,Jun_out,Jul_out,Aug_out,Sep_out,Oct_out,Nov_out,Dec_out))
# season_out_amz<-data.frame(c(Jan_out_amz,Feb_out_amz,Mar_out_amz,Apr_out_amz,May_out_amz,Jun_out_amz,Jul_out_amz,Aug_out_amz,Sep_out_amz,Oct_out_amz,Nov_out_amz,Dec_out_amz))
# season_out_firepit<-data.frame(c(Jan_out_firepit,Feb_out_firepit,Mar_out_firepit,Apr_out_firepit,May_out_firepit,Jun_out_firepit,Jul_out_firepit,Aug_out_firepit,Sep_out_firepit,Oct_out_firepit,Nov_out_firepit,Dec_out_firepit))
```
...
```{r}
sales_out = sales[which(sales$category1=="OUTDOOR"),]
...
```{r}
df_outdoor = df[which(df$Category1=="OUTDOOR"),]
df_outdoor[is.na(df_outdoor)]<-0
...
df_outdoor_4_group<-df_outdoor_4%>%
...
# df_outdoor_4_active<-df_outdoor_4%>%
...
sales_out_1 = sales_temp[which(sales_temp$category1=="OUTDOOR"),]
...
sales_48 <- sales_out_1[which(sales_out_1$`Order Date` <= end_date & sales_out_1$`Order Date` >= start_date), ]
sales_48<-sales_48%>%
...
```{r}
df_outdoor_4_amz<-df_outdoor_4%>%
  filter(merchantid == "AMAZONDIRECTFULFILLMENTCKH")

df_outdoor_4_amz_add<-df_outdoor_4%>%
...
sales_1 = sales_out[which(sales_out$`Order Date`<=as.Date(end_date) & sales_out$`Order Date`>=as.Date(start_date)),]
sales_1<-sales_1%>%
  group_by(`SKU_stockey_sorted`,SKU,`Merchant Name`)%>%
  summarise(`pieces sold` = sum(`pieces sold`))
...
forecast_1_new<-forecast_1%>%
  left_join(df_outdoor_4, by=c("SKU" = "skuorder", "Merchant Name" = "merchantid"))%>%
  ...
  mutate(C32 = ifelse(Category3 == "CHRISTMAS DECORATION", "XMAS", C32))%>%
  mutate(C32 = ifelse(C32 %in% season_out$Category, C32, "Normal"))%>%
  left_join(season_out, by=c("C32" = "Category"))%>%
...
amz_1<-amz_1%>%
  ...
  left_join(df_outdoor_4_amz, by=c("SKUOrder" = "skuorder"))%>%
...
for (i in loop_a){
  amz_1$day_Jan[i] = df_outdoor_4_amz_add$day_Jan[which(df_outdoor_4_amz_add$skuorder==amz_1$SKUOrder[i])[1]]
  amz_1$Jan[i] = df_outdoor_4_amz_add$Jan[which(df_outdoor_4_amz_add$skuorder==amz_1$SKUOrder[i])[1]]
}
...
sales_2 = sales_out[which(sales_out$`Order Date`<=as.Date(end_date) & sales_out$`Order Date`>=as.Date(start_date)),]
sales_2<-sales_2%>%
  group_by(`SKU_stockey_sorted`,SKU,`Merchant Name`)%>%
  summarise(`pieces sold` = sum(`pieces sold`))
...
for (i in loop_a){
  amz_2$day_Feb[i] = df_outdoor_4_amz_add$day_Feb[which(df_outdoor_4_amz_add$skuorder==amz_2$SKUOrder[i])[1]]
  amz_2$Feb[i] = df_outdoor_4_amz_add$Feb[which(df_outdoor_4_amz_add$skuorder==amz_2$SKUOrder[i])[1]]
}
...
sales_3 = sales_out[which(sales_out$`Order Date`<=as.Date(end_date) & sales_out$`Order Date`>=as.Date(start_date)),]
sales_3<-sales_3%>%
  group_by(SKU_stockey_sorted,`SKU`,`Merchant Name`)%>%
  summarise(`pieces sold` = sum(`pieces sold`))
...
for (i in loop_a){
  amz_3$day_Mar[i] = df_outdoor_4_amz_add$day_Mar[which(df_outdoor_4_amz_add$skuorder==amz_3$SKUOrder[i])[1]]
  amz_3$Mar[i] = df_outdoor_4_amz_add$Mar[which(df_outdoor_4_amz_add$skuorder==amz_3$SKUOrder[i])[1]]
}
...
# 
# total_3_hm<-total_3_hm%>%
#    mutate(Mar = Forecast_3 * Mar_out)
#          Feb_1 = Forecast_1 * Feb_out,
#          Mar_1 = Forecast_1 * Mar_out,
#          Apr_1 = Forecast_1 * Apr_out,
#          May_1 = Forecast_1 * May_out,
#          Jun_1 = Forecast_1 * Jun_out,
#          Jul_1 = Forecast_1 * Jul_out,
#          Aug_1 = Forecast_1 * Aug_out,
#          Sep_1 = Forecast_1 * Sep_out,
#          Oct_1 = Forecast_1 * Oct_out,
#          Nov_1 = Forecast_1 * Nov_out,
#          Dec_1 = Forecast_1 * Dec_out,)
```
...
sales_4 = sales_out[which(sales_out$`Order Date`<=as.Date(end_date) & sales_out$`Order Date`>=as.Date(start_date)),]
sales_4<-sales_4%>%
  group_by(`SKU_stockey_sorted`,`SKU`,`Merchant Name`)%>%
  summarise(`pieces sold` = sum(`pieces sold`))
...
for (i in loop_a){
  amz_4$day_Apr[i] = df_outdoor_4_amz_add$day_Apr[which(df_outdoor_4_amz_add$skuorder==amz_4$SKUOrder[i])[1]]
  amz_4$Apr[i] = df_outdoor_4_amz_add$Apr[which(df_outdoor_4_amz_add$skuorder==amz_4$SKUOrder[i])[1]]
}
...
sales_5 = sales_out[which(sales_out$`Order Date`<=as.Date(end_date) & sales_out$`Order Date`>=as.Date(start_date)),]
sales_5<-sales_5%>%
  group_by(`SKU_stockey_sorted`,`SKU`,`Merchant Name`)%>%
  summarise(`pieces sold` = sum(`pieces sold`))
...
for (i in loop_a){
  amz_5$day_May[i] = df_outdoor_4_amz_add$day_May[which(df_outdoor_4_amz_add$skuorder==amz_5$SKUOrder[i])[1]]
  amz_5$May[i] = df_outdoor_4_amz_add$May[which(df_outdoor_4_amz_add$skuorder==amz_5$SKUOrder[i])[1]]
}
...
# 
#  total_5_hm<-total_5_hm%>%
#    mutate(May = Forecast_5 * May_out)
#          Feb_5 = Forecast_5 * Feb_out,
#          Mar_5 = Forecast_5 * Mar_out,
#          Apr_5 = Forecast_5 * Apr_out,
#          May_5 = Forecast_5 * May_out,
#          Jun_5 = Forecast_5 * Jun_out,
#          Jul_5 = Forecast_5 * Jul_out,
#          Aug_5 = Forecast_5 * Aug_out,
#          Sep_5 = Forecast_5 * Sep_out,
#          Oct_5 = Forecast_5 * Oct_out,
#          Nov_5 = Forecast_5 * Nov_out,
#          Dec_5 = Forecast_5 * Dec_out,)
```
...
sales_6 = sales_out[which(sales_out$`Order Date`<=as.Date(end_date) & sales_out$`Order Date`>=as.Date(start_date)),]
sales_6<-sales_6%>%
  group_by(`SKU_stockey_sorted`,`SKU`,`Merchant Name`)%>%
  summarise(`pieces sold` = sum(`pieces sold`))
...
for (i in loop_a){
  amz_6$day_Jun[i] = df_outdoor_4_amz_add$day_Jun[which(df_outdoor_4_amz_add$skuorder==amz_6$SKUOrder[i])[1]]
  amz_6$Jun[i] = df_outdoor_4_amz_add$Jun[which(df_outdoor_4_amz_add$skuorder==amz_6$SKUOrder[i])[1]]
}
...
# 
#  total_6_hm<-total_6_hm%>%
#    mutate(Jun = Forecast_6 * Jun_out)
#          Feb_6 = Forecast_6 * Feb_out,
#          Mar_6 = Forecast_6 * Mar_out,
#          Apr_6 = Forecast_6 * Apr_out,
#          May_6 = Forecast_6 * May_out,
#          Jun_6 = Forecast_6 * Jun_out,
#          Jul_6 = Forecast_6 * Jul_out,
#          Aug_6 = Forecast_6 * Aug_out,
#          Sep_6 = Forecast_6 * Sep_out,
#          Oct_6 = Forecast_6 * Oct_out,
#          Nov_6 = Forecast_6 * Nov_out,
#          Dec_6 = Forecast_6 * Dec_out,)
```
...
sales_7 = sales_out[which(sales_out$`Order Date`<=as.Date(end_date) & sales_out$`Order Date`>=as.Date(start_date)),]
sales_7<-sales_7%>%
  group_by(`SKU_stockey_sorted`,`SKU`,`Merchant Name`)%>%
  summarise(`pieces sold` = sum(`pieces sold`))
...
for (i in loop_a){
  amz_7$day_Jul[i] = df_outdoor_4_amz_add$day_Jul[which(df_outdoor_4_amz_add$skuorder==amz_7$SKUOrder[i])[1]]
  amz_7$Jul[i] = df_outdoor_4_amz_add$Jul[which(df_outdoor_4_amz_add$skuorder==amz_7$SKUOrder[i])[1]]
}
...
# 
#  total_7_hm<-total_7_hm%>%
#    mutate(Jul = Forecast_7 * Jul_out)
#          Feb_7 = Forecast_7 * Feb_out,
#          Mar_7 = Forecast_7 * Mar_out,
#          Apr_7 = Forecast_7 * Apr_out,
#          May_7 = Forecast_7 * May_out,
#          Jun_7 = Forecast_7 * Jun_out,
#          Jul_7 = Forecast_7 * Jul_out,
#          Aug_7 = Forecast_7 * Aug_out,
#          Sep_7 = Forecast_7 * Sep_out,
#          Oct_7 = Forecast_7 * Oct_out,
#          Nov_7 = Forecast_7 * Nov_out,
#          Dec_7 = Forecast_7 * Dec_out,)
```
...
sales_8 = sales_out[which(sales_out$`Order Date`<=as.Date(end_date) & sales_out$`Order Date`>=as.Date(start_date)),]
sales_8<-sales_8%>%
  group_by(`SKU_stockey_sorted`,`SKU`,`Merchant Name`)%>%
  summarise(`pieces sold` = sum(`pieces sold`))
...
for (i in loop_a){
  amz_8$day_Aug[i] = df_outdoor_4_amz_add$day_Aug[which(df_outdoor_4_amz_add$skuorder==amz_8$SKUOrder[i])[1]]
  amz_8$Aug[i] = df_outdoor_4_amz_add$Aug[which(df_outdoor_4_amz_add$skuorder==amz_8$SKUOrder[i])[1]]
}
...
# 
#  total_8_hm<-total_8_hm%>%
#    mutate(Aug = Forecast_8 * Aug_out)
#          Feb_8 = Forecast_8 * Feb_out,
#          Mar_8 = Forecast_8 * Mar_out,
#          Apr_8 = Forecast_8 * Apr_out,
#          May_8 = Forecast_8 * May_out,
#          Jun_8 = Forecast_8 * Jun_out,
#          Jul_8 = Forecast_8 * Jul_out,
#          Aug_8 = Forecast_8 * Aug_out,
#          Sep_8 = Forecast_8 * Sep_out,
#          Oct_8 = Forecast_8 * Oct_out,
#          Nov_8 = Forecast_8 * Nov_out,
#          Dec_8 = Forecast_8 * Dec_out,)
```
...
sales_9 = sales_out[which(sales_out$`Order Date`<=as.Date(end_date) & sales_out$`Order Date`>=as.Date(start_date)),]
sales_9<-sales_9%>%
  group_by(`SKU_stockey_sorted`,`SKU`,`Merchant Name`)%>%
  summarise(`pieces sold` = sum(`pieces sold`))
...
for (i in loop_a){
  amz_9$day_Sep[i] = df_outdoor_4_amz_add$day_Sep[which(df_outdoor_4_amz_add$skuorder==amz_9$SKUOrder[i])[1]]
  amz_9$Sep[i] = df_outdoor_4_amz_add$Sep[which(df_outdoor_4_amz_add$skuorder==amz_9$SKUOrder[i])[1]]
}
...
# 
#  total_9_hm<-total_9_hm%>%
#    mutate(Sep = Forecast_9 * Sep_out)
#          Feb_9 = Forecast_9 * Feb_out,
#          Mar_9 = Forecast_9 * Mar_out,
#          Apr_9 = Forecast_9 * Apr_out,
#          May_9 = Forecast_9 * May_out,
#          Jun_9 = Forecast_9 * Jun_out,
#          Jul_9 = Forecast_9 * Jul_out,
#          Aug_9 = Forecast_9 * Aug_out,
#          Sep_9 = Forecast_9 * Sep_out,
#          Oct_9 = Forecast_9 * Oct_out,
#          Nov_9 = Forecast_9 * Nov_out,
#          Dec_9 = Forecast_9 * Dec_out,)
```
...
sales_10 = sales_out[which(sales_out$`Order Date`<=as.Date(end_date) & sales_out$`Order Date`>=as.Date(start_date)),]
sales_10<-sales_10%>%
  group_by(`SKU_stockey_sorted`,`SKU`,`Merchant Name`)%>%
  summarise(`pieces sold` = sum(`pieces sold`))
...
for (i in loop_a){
  amz_10$day_Oct[i] = df_outdoor_4_amz_add$day_Oct[which(df_outdoor_4_amz_add$skuorder==amz_10$SKUOrder[i])[1]]
  amz_10$Oct[i] = df_outdoor_4_amz_add$Oct[which(df_outdoor_4_amz_add$skuorder==amz_10$SKUOrder[i])[1]]
}
...
# 
#  total_10_hm<-total_10_hm%>%
#    mutate(Oct = Forecast_10 * Oct_out)
#          Feb_10 = Forecast_10 * Feb_out,
#          Mar_10 = Forecast_10 * Mar_out,
#          Apr_10 = Forecast_10 * Apr_out,
#          May_10 = Forecast_10 * May_out,
#          Jun_10 = Forecast_10 * Jun_out,
#          Jul_10 = Forecast_10 * Jul_out,
#          Aug_10 = Forecast_10 * Aug_out,
#          Sep_10 = Forecast_10 * Sep_out,
#          Oct_10 = Forecast_10 * Oct_out,
#          Nov_10 = Forecast_10 * Nov_out,
#          Dec_10 = Forecast_10 * Dec_out,)
```
...
sales_11 = sales_out[which(sales_out$`Order Date`<=as.Date(end_date) & sales_out$`Order Date`>=as.Date(start_date)),]
sales_11<-sales_11%>%
  group_by(`SKU_stockey_sorted`,`SKU`,`Merchant Name`)%>%
  summarise(`pieces sold` = sum(`pieces sold`))
...
for (i in loop_a){
  amz_11$day_Nov[i] = df_outdoor_4_amz_add$day_Nov[which(df_outdoor_4_amz_add$skuorder==amz_11$SKUOrder[i])[1]]
  amz_11$Nov[i] = df_outdoor_4_amz_add$Nov[which(df_outdoor_4_amz_add$skuorder==amz_11$SKUOrder[i])[1]]
}
...
# 
#  total_11_hm<-total_11_hm%>%
#    mutate(Nov = Forecast_11 * Nov_out)
#          Feb_11 = Forecast_11 * Feb_out,
#          Mar_11 = Forecast_11 * Mar_out,
#          Apr_11 = Forecast_11 * Apr_out,
#          May_11 = Forecast_11 * May_out,
#          Jun_11 = Forecast_11 * Jun_out,
#          Jul_11 = Forecast_11 * Jul_out,
#          Aug_11 = Forecast_11 * Aug_out,
#          Sep_11 = Forecast_11 * Sep_out,
#          Oct_11 = Forecast_11 * Oct_out,
#          Nov_11 = Forecast_11 * Nov_out,
#          Dec_11 = Forecast_11 * Dec_out,)
...
sales_12 = sales_out[which(sales_out$`Order Date`<=as.Date(end_date) & sales_out$`Order Date`>=as.Date(start_date)),]
sales_12<-sales_12%>%
  group_by(`SKU_stockey_sorted`,`SKU`,`Merchant Name`)%>%
  summarise(`pieces sold` = sum(`pieces sold`))
...
for (i in loop_a){
  amz_12$day_Dec[i] = df_outdoor_4_amz_add$day_Dec[which(df_outdoor_4_amz_add$skuorder==amz_12$SKUOrder[i])[1]]
  amz_12$Dec[i] = df_outdoor_4_amz_add$Dec[which(df_outdoor_4_amz_add$skuorder==amz_12$SKUOrder[i])[1]]
}
...
# 
#  total_12_hm<-total_12_hm%>%
#    mutate(Dec = Forecast_12 * Dec_out)
#          Feb_12 = Forecast_12 * Feb_out,
#          Mar_12 = Forecast_12 * Mar_out,
#          Apr_12 = Forecast_12 * Apr_out,
#          May_12 = Forecast_12 * May_out,
#          Jun_12 = Forecast_12 * Jun_out,
#          Jul_12 = Forecast_12 * Jul_out,
#          Aug_12 = Forecast_12 * Aug_out,
#          Sep_12 = Forecast_12 * Sep_out,
#          Oct_12 = Forecast_12 * Oct_out,
#          Nov_12 = Forecast_12 * Nov_out,
#          Dec_12 = Forecast_12 * Dec_out,)
```

```{r}
# total_outdoor<-total_1_hm%>%
...
```{r}
total_outdoor_sku_new<-forecast_1_new%>%
  ...
  #left_join(df_outdoor_4_group, by=c("SKU" = "skuorder", "Merchant Name" = "merchantid"))%>%
...
total_outdoor_sku_new_group<-total_outdoor_sku_new%>%
  left_join(df_outdoor_4_group, by=c("Merchant Name" = "merchantid", "SKU_stockey_sorted"))

total_outdoor_sku_new_online<-total_outdoor_sku_new
  # left_join(sku_online, by=c("SKU" = "skuorder", "Merchant Name" = "merchantid"))
```

```{r}
total_outdoor_amz_new<-amz_Jan_sku_stockey%>%
...
```{r}
# total_outdoor_sku_new_online<-total_outdoor_sku_new_online%>%
#   mutate(`yearly_forecast` = ifelse(Offline_Reasons_Clean == "Has Inventory we not push-Product-PriceIssue"|Offline_Reasons_Clean == "Has Inventory we not push-Product-LowMargin"|Offline_Reasons_Clean == "NotActiveAtExtranet", `yearly_forecast` - `yearly_forecast`*Jan_out - `yearly_forecast`*Feb_out - `yearly_forecast`*Mar_out , `yearly_forecast`))

total_outdoor_sku_new_master<-total_outdoor_sku_new_online%>%
  group_by(`SKU_stockey_sorted`)%>%
  summarise(`total_yearly` = sum(`yearly_forecast`))
  # full_join(total_outdoor_amz_new, by=c("SKU_stockey_sorted"))%>%
  # replace(is.na(.),0)%>%
...
total_hm_out <- sku_hm_map_cleaned%>%
  full_join(total_outdoor_sku_new_master, by = c("SKU_stockey_sorted"))%>%
...
total_hm_out$`HM pieces sold`[which(is.na(total_hm_out$`HM pieces sold`))]<-0
total_hm_out<-total_hm_out%>%
  group_by(`HM_stockey`)%>%
  summarise(`Forecast` = sum(`HM pieces sold`))
total_hm_out$`Forecast`[which(is.na(total_hm_out$`Forecast`))]<-0


# outdoor_fc<-assortment_out%>%
#   select(stockkey, `Last First Cost`)
# 
# total_outdoor_hm_new<-total_hm_out%>%
#   left_join(outdoor_fc, by=c("HM_stockey" = "stockkey"))%>%
#   filter(!is.na(`Last First Cost`))%>%
#   mutate(yearly_amount_new = Forecast * `Last First Cost`)



total_outdoor_sku_new_master_amz<-total_outdoor_amz_new%>%
  group_by(`SKU_stockey_sorted`)%>%
...
total_hm_amz_out <- sku_hm_map_cleaned%>%
  full_join(total_outdoor_sku_new_master_amz, by = c("SKU_stockey_sorted"))%>%
  ...
  arrange(`SKU_stockey_sorted`)
total_hm_amz_out$`HM pieces sold`[which(is.na(total_hm_amz_out$`HM pieces sold`))]<-0
total_hm_amz_out$`DI pieces sold`[which(is.na(total_hm_amz_out$`DI pieces sold`))]<-0
total_hm_amz_out$`IN pieces sold`[which(is.na(total_hm_amz_out$`IN pieces sold`))]<-0
total_hm_amz_out$`DF pieces sold`[which(is.na(total_hm_amz_out$`DF pieces sold`))]<-0
total_hm_amz_out<-total_hm_amz_out%>%
  group_by(`HM_stockey`)%>%
  summarise(`Forecast` = sum(`HM pieces sold`),
            DI_forecast = sum(`DI pieces sold`),
            IN_forecast = sum(`IN pieces sold`),
            DF_forecast = sum(`DF pieces sold`))
total_hm_amz_out$`Forecast`[which(is.na(total_hm_amz_out$`Forecast`))]<-0
total_hm_amz_out$DI_forecast[which(is.na(total_hm_amz_out$DI_forecast))]<-0
total_hm_amz_out$IN_forecast[which(is.na(total_hm_amz_out$IN_forecast))]<-0
total_hm_amz_out$DF_forecast[which(is.na(total_hm_amz_out$DF_forecast))]<-0

# total_outdoor_hm_new_amz<-total_hm_amz_out%>%
#   left_join(outdoor_fc, by=c("HM_stockey" = "stockkey"))%>%
#   filter(!is.na(`Last First Cost`))%>%
#   mutate(yearly_amount_new = Forecast * `Last First Cost`,
#          DI_amount = DI_forecast * `Last First Cost`,
#          IN_amount = IN_forecast * `Last First Cost`,
#          DF_amount = DF_forecast * `Last First Cost`)%>%
...
# season_2023_out<-sum(season_out[month_today:12,])

hm_c32<-assortment_out%>%
...
total_hm_out_new1<-total_hm_out%>%
  ...
  mutate(`New Category3-2` = ifelse(`New Category3-2` %in% season_out$Category, `New Category3-2`, "Normal"))%>%
  left_join(season_out, by=c("New Category3-2" = "Category"))
total_hm_out_new<-total_hm_out_new1%>%
  mutate(season_2023_out = rowSums(total_hm_out_new1[, month_names]))%>%
  mutate(`2023 forecast pieces sold` = Forecast * season_2023_out,
...
total_hm_amz_out_new1<-total_hm_amz_out%>%
  full_join(amz_2023, by=c("HM_stockey"))%>%
  mutate_at(c("2023 amz actual pieces sold"), ~replace_na(.,0))%>%
  left_join(hm_c32, by=c("HM_stockey" = "stockkey"))%>%
  mutate(`New Category3-2` = ifelse(`New Category3-2` %in% season_out$Category, `New Category3-2`, "Normal"))%>%
  left_join(season_out, by=c("New Category3-2" = "Category"))
total_hm_amz_out_new<-total_hm_amz_out_new1%>%
  mutate(season_2023_out = rowSums(total_hm_amz_out_new1[, month_names]))%>%
  mutate(`2023 forecast pieces sold` = Forecast * season_2023_out,
...
sku_hm_map_count1<-sku_hm_map_cleaned%>%
  filter(HM_Count == 1)
total_outdoor_sku_new_online_sets<-total_outdoor_sku_new_online%>%
...
```{r}
write_xlsx(total_outdoor_sku_new_online_sets,"C:\\Users\\Yulin Pan\\Desktop\\48&12&4\\Oct 2023\\SKU_stockey_sorted forecast NON-AMAZON out.xlsx")
write_xlsx(total_outdoor_amz_new,"C:\\Users\\Yulin Pan\\Desktop\\48&12&4\\Oct 2023\\SKU_stockey_sorted forecast AMAZON out.xlsx")
```
